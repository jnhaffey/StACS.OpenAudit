...
{
    [TestClass]
    public class AuditEventAsChangeToTests
    {
        ...
        public void Create_Instance_Non_Generic()
        {
            ...
            // Act
            var auditEvent = AuditEvent.AsChangeTo(_testCustomer.GetType(), _testCustomer.Id.ToString());
        ...
        public void Create_Instance_Generic()
        {
            ...
            // Act
            var auditEvent = AuditEvent.AsChangeTo(_testCustomer, tc => tc.Id.ToString());
