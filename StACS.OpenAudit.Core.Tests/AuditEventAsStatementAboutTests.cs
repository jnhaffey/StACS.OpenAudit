...
{
    [TestClass]
    public class AuditEventAsStatementAboutTests
    {
        ...
        public void Create_Instance_Non_Generic()
        {
            ...
            // Act
            var auditEvent = AuditEvent.AsStatementAbout(_testCustomer.GetType(), _testCustomer.Id.ToString());

            // Assert
            auditEvent.OperationType.Should().Be(OperationType.Statement);
        ...
        public void Create_Instance_Generic()
        {
            ...
            // Act
            var auditEvent = AuditEvent.AsStatementAbout(_testCustomer, tc => tc.Id.ToString());
